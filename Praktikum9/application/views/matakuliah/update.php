...
<?php
    $hidden = ['idedit' =>$mkedit->kode];
?>
<?php echo form_open('matakuliah/save','',$hidden)?>
<form>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="kode" name="kode" value="<?=$mkedit->kode?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama" name="nama" value="<?=$mkedit->nama?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="jam" name="jam" value="<?=$mkedit->jam?>" type="text" class="form-control" placeholder="00:00">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="sks" name="sks" value="<?=$mkedit->sks?>" type="number" min="1" max="5" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="dosen" name="dosen" value="<?=$mkedit->dosen?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
